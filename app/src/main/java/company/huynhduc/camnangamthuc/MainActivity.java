...
import company.huynhduc.adapter.ViewPagerAdapter;
import company.luongchung.camnangamthuc.R;
import company.huynhduc.model.MonAn;
import company.huynhduc.utils.BottomNavigationHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface font = Typeface.createFromAsset(getAssets(),"fonts/UVNBanhMi.ttf");
